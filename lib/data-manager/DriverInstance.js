...
var sparqlStreams = dataManager.sparqlStreams;
...
Object.defineProperty(DriverInstance.prototype, 'sparqlStream', {
  get: function() {
    var instanceId = this['@id'];
    return sparqlStreams[instanceId];
  },
  set: function(obj) {
    var instanceId = this['@id'];
    sparqlStreams[instanceId] = obj;
  }
});
...
DriverInstance.prototype.fetch = function() {
  ...
  return new Promise(function(resolve, reject) {
    self.sparqlStream.once('end', function() {
      console.log('Resolving...');
      self.isFetching = false;

      if (self.isMeta) {
        self.log('info', 'Meta driver: refreshing driverObject cache...');
