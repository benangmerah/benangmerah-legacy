...
var driverDetails = dataManager.driverDetails = {};
var driverInstances = dataManager.driverInstances = [];
var instanceLogs = dataManager.instanceLogs = {};
var instanceObjects = dataManager.instanceObjects = {};

var DriverSparqlStream = dataManager.DriverSparqlStream =
  require('./DriverSparqlStream');
var DriverInstance = dataManager.DriverInstance =
  require('./DriverInstance');
...
dataManager.fetchDriverInstances = function(callback) {
  conn.getGraph({
    ...
    dataManager.driverInstances = _.map(graph, dataManager.prepareInstance);
...
dataManager.prepareInstance = function(rawDriverInstance) {
  return new DriverInstance(rawDriverInstance);
};
